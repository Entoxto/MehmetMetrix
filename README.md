...
### Python скрипты (папка `Exel/`)

| Команда | Описание |
|---------|----------|
| `python parse_excel.py` | Парсинг Excel файла в `data/shipments.json` |
| `python update_prices.py` | Обновление цен в `data/products.json` из поставок |
...
### Backend/Утилиты
- **Python 3.x** — парсинг Excel файлов
