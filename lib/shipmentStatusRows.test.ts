...
import { buildShipmentStatusRows } from "./shipmentStatusRows";
...
describe("buildShipmentStatusRows", () => {
  it('должен группировать позиции с одинаковым текстовым статусом в одну строку', () => {
    ...
    const result = buildShipmentStatusRows(positions);
  ...
  it('должен возвращать пустой список если позиций нет', () => {
    const result = buildShipmentStatusRows([]);
